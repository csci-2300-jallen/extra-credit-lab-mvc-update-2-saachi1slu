...
{
    QObject::connect(view->getUndoButton(), &QPushButton::clicked, [this]()
                     { undo(); });
    QObject::connect(view->getRedoButton(), &QPushButton::clicked, [this]()
                     { redo(); });
    QObject::connect(view->getSaveButton(), &QPushButton::clicked, [this]()
                     { saveHistory(); });
    QObject::connect(view->getLoadButton(), &QPushButton::clicked, [this]()
                     { loadHistory(); });
}
